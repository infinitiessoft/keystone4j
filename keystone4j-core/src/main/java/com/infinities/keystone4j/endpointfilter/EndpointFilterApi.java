...
public interface EndpointFilterApi extends Api {

	void addEndpointToProject(String endpointid, String projectid);

	void checkEndpointInProject(String endpointid, String projectid);

	void removeEndpointFromProject(String endpointid, String projectid);
