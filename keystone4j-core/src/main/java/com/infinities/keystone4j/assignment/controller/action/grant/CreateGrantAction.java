...
public class CreateGrantAction extends AbstractGrantAction implements ProtectedAction<Role> {
	...
	public CreateGrantAction(AssignmentApi assignmentApi, IdentityApi identityApi, TokenProviderApi tokenProviderApi,
	...
	public MemberWrapper<Role> execute(ContainerRequestContext request) throws Exception {
		...
		assignmentApi.createGrant(roleid, userid, groupid, domainid, projectid, checkIfInherited(request));
		return null;
	}
