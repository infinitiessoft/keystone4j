...
public class RemoveUserFromGroupCommand extends AbstractIdentityCommand implements NonTruncatedCommand<User> {
	...
	public RemoveUserFromGroupCommand(AssignmentApi assignmentApi, CredentialApi credentialApi, RevokeApi revokeApi,
	...
	public User execute() throws Exception {
		...
		groupDriver.removeUserFromGroup(userEntityId, groupEntityId);
