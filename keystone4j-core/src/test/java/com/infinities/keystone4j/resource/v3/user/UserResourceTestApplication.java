...
public class UserResourceTestApplication extends ResourceConfig {

	public UserResourceTestApplication(CatalogApi catalogApi, TokenApi tokenApi, TokenProviderApi tokenProviderApi,
