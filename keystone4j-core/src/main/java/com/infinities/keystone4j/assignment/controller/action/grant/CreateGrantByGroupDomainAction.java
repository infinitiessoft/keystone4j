...
public class CreateGrantByGroupDomainAction extends AbstractGrantAction implements ProtectedAction<Role> {
	...
	public CreateGrantByGroupDomainAction(AssignmentApi assignmentApi, IdentityApi identityApi,
	...
	public MemberWrapper<Role> execute(ContainerRequestContext request) {
		assignmentApi.createGrantByGroupDomain(roleid, groupid, domainid, checkIfInherited(request));
		return null;
	}
