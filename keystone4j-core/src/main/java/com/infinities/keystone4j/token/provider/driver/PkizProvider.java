...
public class PkizProvider extends BaseProvider {
	...
	private final static Logger logger = LoggerFactory.getLogger(PkizProvider.class);


	public PkizProvider(IdentityApi identityApi, AssignmentApi assignmentApi, CatalogApi catalogApi, TrustApi trustApi) {
