...
public class GroupResourceTestApplication extends ResourceConfig {

	public GroupResourceTestApplication(CatalogApi catalogApi, TokenApi tokenApi, TokenProviderApi tokenProviderApi,
