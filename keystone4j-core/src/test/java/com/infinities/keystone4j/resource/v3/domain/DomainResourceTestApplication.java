...
public class DomainResourceTestApplication extends ResourceConfig {

	public DomainResourceTestApplication(CatalogApi catalogApi, TokenApi tokenApi, TokenProviderApi tokenProviderApi,
