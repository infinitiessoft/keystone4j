...
public class ValidateTokenAction extends AbstractTokenAction implements ProtectedAction<Access> {
	...
	@Override
	public TokenV2DataWrapper execute(ContainerRequestContext request) throws Exception {
