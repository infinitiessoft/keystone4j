...
public class RoleResourceTestApplication extends ResourceConfig {

	public RoleResourceTestApplication(CatalogApi catalogApi, TokenApi tokenApi, TokenProviderApi tokenProviderApi,
