...
public class CheckGrantByUserDomainAction extends AbstractGrantAction implements ProtectedAction<Role> {
	...
	public CheckGrantByUserDomainAction(AssignmentApi assignmentApi, IdentityApi identityApi,
	...
	public MemberWrapper<Role> execute(ContainerRequestContext request) {
		assignmentApi.getGrantByUserDomain(roleid, userid, domainid, checkIfInherited(request));
		return null;
	}
