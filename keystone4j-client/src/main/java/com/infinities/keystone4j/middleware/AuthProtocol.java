...
public class AuthProtocol {
	...
	private String signingDirname;
	private final TokenCache tokenCache;
	private final boolean delayAuthDecision;
	private final boolean checkRevocationsForCached;
	protected IdentityServer identityServer;
	private Calendar tokenRevocationListFetchedTimeProp;
	private final String revokedFileName;
	private final int tokenRevocationListCacheTimeout;
	private RevokedWrapper tokenRevocationListProp;
	private final boolean includeServiceCatalog;
	private final String signingCertFileName;
	private final String signingCaFileName;
	...
	public void call(ContainerRequestContext env) throws IOException {
		...
		tokenCache.initialize(env);
		try {
			removeAuthHeaders(env);
			String userToken = getUserTokenFromHeader(env);
			TokenWrapper tokenInfo = validateUserToken(userToken, env, true);
	...
	private Map<String, String> buildUserHeaders(TokenWrapper tokenInfo) throws IOException {
	...
	private TokenWrapper validateUserToken(String userToken, ContainerRequestContext env, boolean retry) {
		String tokenId = null;
	...
	private void confirmTokenBind(TokenWrapper data, ContainerRequestContext env) {
